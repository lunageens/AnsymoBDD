...
public class CourseStories extends JUnitStories {

    public CourseStories() {
        ...
        StoryReporterBuilder reporterBuilder = new StoryReporterBuilder()
                .withCodeLocation(CodeLocations.codeLocationFromClass(CourseStories.class)).withFailureTrace(true)
        ...
        Configuration configuration = new SeleniumConfiguration().useWebDriverProvider(driverProvider)
                ...
                .useStoryLoader(new LoadFromClasspath(CourseStories.class))
        ...
        steps.addComponent(new ClassName("CourseSteps"));
